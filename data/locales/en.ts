const en = {
  ...
  hero: {
    badge: "Business Payment Infrastructure",
    title: "Pay suppliers, contractors and businesses",
    subtitle:
  ...
  exchange: {
    badge: "Create Request",
    title: "Crypto-to-Bank Payout Request",
    subtitle:
      "Set up a payout to a bank card, personal account or corporate bank account.",
    steps: ["Asset & Amount", "Payout Details", "Recipient"],
    assetTitle: "Asset & Amount",
    ...
    recipientPlaceholder: "Card number, account number or company bank details",
    flowSend: "You send cryptocurrency",
    flowReceive: "Recipient receives local currency",
    recipientTypes: ["Individual", "Business"],
    payoutMethods: ["Bank card", "Personal account", "Corporate account"],
    submit: "Create Request",
    creating: "Creating...",
    footnote: "Rates and fees are confirmed before the request is finalized.",
    successHeading: "Request created",
    successText: "Your payout request has been submitted for processing.",
    requestNumberLabel: "Request number",
    errors: {
      crypto: "Enter a valid crypto amount.",
      payout: "Enter a valid payout amount.",
      recipient: "Enter the recipient details.",
      generic: "Failed to create request. Please try again.",
    },
  },
  status: {
    badge: "Request Status",
    title: "Track Your Business Payout Request",
    subtitle:
      "Monitor every stage of your crypto-to-bank settlement — from supplier payments to corporate bank account payouts across CIS countries.",
    trustPoints: [
      "Corporate bank account payouts",
      "Supplier & contractor settlements",
      "AML-monitored processing",
    ],
    inputPlaceholder: "e.g. NX-2026-0001",
    trackButton: "Track Request",
    requestWord: "Request",
    currentStatus: "AML Review",
    fields: {
    ...
    samplePayout: "Corporate Account",
    steps: [
      "Request Created",
